...
#define STRING_CONFIG_H_AUTHOR "(hunterius_prime, Ender-3)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //bed autotune result
  #define DEFAULT_bedKp 182.78
  #define DEFAULT_bedKi 33.81
  #define DEFAULT_bedKd 658.69
...
#define DEBUG_LEVELING_FEATURE
  ...
  #define G26_MESH_VALIDATION
    ...
    #define G26_RETRACT_MULTIPLIER   1  // G26 Q (retraction) used by default between mesh test elements.
  #endif
